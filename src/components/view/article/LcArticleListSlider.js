    ...
    renderFigure (item) {
      ...
      return this.$createElement('figure', { style: { height: '100%', position: 'relative' } }, [
        this.$createElement('img', {
          ...
          attrs: {
            [this.isVisible ? 'src' : 'data-src']: getImageSrc(this.getPreviewImage(item)).src
          }
        }),
              ...
              h('figure', { style: { height: '100%' } }, [
                h('img', {
                  ...
                  attrs: {
                    // width: height,
                    // height: height,
                    [this.isVisible ? 'src' : 'data-src']: getImageSrc(this.getPreviewImage(item), height + ':round').src
                  }
                })
              ])
            ]),
