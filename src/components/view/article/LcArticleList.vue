...
<script>
  ...
  import LcArticleListItem from './LcArticleListItem'
  import LcArticleListItemCard from './LcArticleListItemCard'
  import LcArticleListSlider from './LcArticleListSlider'
  ...
  export default {
    name: 'LcArticleList',
    components: {
      LcArticleListItem, LcArticleListItemCard, LcArticleListSlider
    },
    props: {
      showCount: {
        type: Boolean,
